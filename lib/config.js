 ...
 *       ...
 *     },
 *     "apiKeysV2": {  // ← NEW: Multi-key support
 *       "groq": {
 *         "keys": [
 *           {"key": "gsk_xxx", "weight": 50, "priority": 1},
 *           {"key": "gsk_yyy", "weight": 50, "priority": 2}
 *         ],
 *         "rotation": "round-robin",  // round-robin, weighted, priority, random
 *         "fallback": true
 *       }
 *     },
 *     "providers": {
